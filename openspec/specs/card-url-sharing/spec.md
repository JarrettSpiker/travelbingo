...
- **WHEN** the app loads a URL whose payload predates a field such as the free-space toggle, title color, or font scheme
- **THEN** the system SHALL apply the default value for each missing field and SHALL still restore the rest of the card's state

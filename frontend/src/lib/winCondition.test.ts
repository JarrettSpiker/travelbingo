...
import { CELLS_PER_CARD } from "./bingo";
import { completedLines, hasWon, LINES, squaresFromWin } from "./winCondition";
...
// in backend/src/lib/winCondition.test.ts; the two must stay identical.
